...
if (isset($_GET['eliminar']) && isset($_GET['id'])) {
    ...
    if (!mysqli_connect_errno()) {
        ...
        $result_carrito = mysqli_query($con, "SELECT COUNT(*) as count FROM carrito WHERE id_producto = $id_producto");
        $count_carrito = mysqli_fetch_array($result_carrito)['count'];
        
        $result_historial = mysqli_query($con, "SELECT COUNT(*) as count FROM historial_compras WHERE id_producto = $id_producto");
        ...
        if ($count_carrito > 0 || $count_historial > 0) {
            ...
            mysqli_query($con, "UPDATE producto SET cantidad_disponible = 0 WHERE id_producto = $id_producto");
            ...
            $imagen_path = "../img/productos/$id_producto.png";
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300 min-h-screen">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-y-2">
                                <div class="flex flex-col space-y-2">
                                    ...
                                    <button onclick="confirmarEliminacion(<?= $row['id_producto'] ?>, '<?= htmlspecialchars($row['nombre_producto'], ENT_QUOTES) ?>')"
    ...
    <script>
        ...
        function confirmarEliminacion(id, nombre) {
            ...
            document.getElementById('confirmBtn').href = `./gestion_productos.php?eliminar=1&id=${id}`;
